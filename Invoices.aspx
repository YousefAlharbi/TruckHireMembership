<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Invoices.aspx.cs" Inherits="Invoices" %>
...
<body>
	...
	<div id="content">
        ...
        <div id="stylized" class="myform">
            ...
            <br />
            <asp:Button ID="btnGetRebates" runat="server" Text="Get Invoices" 
                ValidationGroup="V" onclick="btnGetRebates_Click" />
            <p>
                ...
                <asp:SqlDataSource ID="RebateDisplay" runat="server" 
                    ...
                    SelectCommand="SELECT [transactionid], [membershipid], [first_name], [last_name], [startdate], [rebate] FROM [transactionlog]">
                </asp:SqlDataSource>
            &nbsp;</p>
